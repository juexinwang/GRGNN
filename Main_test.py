...
if args.traindata_name is not None:
    ...
    trainNet_agent0 = np.load(args.file_dir+'/data/dream/'+trdata_name+'_rmatrix_0.001.npy',allow_pickle=True).tolist()
    trainNet_agent1 = np.load(args.file_dir+'/data/dream/'+trdata_name+'_rmatrix_0.001.npy',allow_pickle=True).tolist()
    ...
    # Random network as the starting skeletons
    testNet_agent0 = np.load(args.file_dir+'/data/dream/'+tedata_name+'_rmatrix_0.001.npy',allow_pickle=True).tolist()
    testNet_agent1 = np.load(args.file_dir+'/data/dream/'+tedata_name+'_rmatrix_0.001.npy',allow_pickle=True).tolist()
